  ...
  <v-layout row wrap>
    <v-flex sm12 lg12 xl9 mx-auto>
      <v-img src="/receipt/receipt-bg.png" class="mx-auto bg">
        ...
        <div class="receipt-number font-weight-bold">RECEIPT NO : <span class="font-weight-regular">{{ result.ReceiptNumber }}</span></div>
        ...
        <v-layout row wrap mt-3 v-if="result.receipt_type == 'TAX'">
          <v-flex xs6 md6 lg6>
            ...
            <v-sheet style="border-radius: unset" class="font-weight-bold ml-4 transparent">
              ...
              <div class="receipt-item">Office Address :</div>
              ...
              <!-- <div class="receipt-item">Period Covered :</div> -->
          ...
          <v-flex xs6 md6 lg6>
            ...
            <v-sheet style="border-radius: unset; opacity: 0.6" class="mr-4 grey lighten-2">
              <div class="receipt-item">{{ result.PaymentDate }}</div>
              <div class="receipt-item">{{ result.ANSSID }}</div>
              <div class="receipt-item">{{ result.PayerName }}</div>
              <div class="receipt-item">{{ result.TaxPayerAddress }}&nbsp;</div>
              <div class="receipt-item">{{ result.OfficeAddress }}&nbsp;</div>
              <div class="receipt-item">({{ result.RevenueCode }})</div>
              <div class="receipt-item">{{ result.MDAIDName }}</div>
              <div class="receipt-item">{{ result.RevenueName }}</div>
              <div class="receipt-item" style="height:40px;">(N{{ result.Amount }}) {{ result.Amount | toWords }} naira only</div>
              <div class="receipt-item">{{ result.PaymentChannel }}</div>
              <div class="receipt-item">{{ result.PaymentReference }}</div>
              <!-- <div class="receipt-item">2019</div> -->
              <div class="receipt-item">{{ result.Issuer }}</div>
              <div class="receipt-item">{{ result.DateIssued }}</div>
              <div class="receipt-item">{{ result.TaxOffice }}</div>
              <div class="receipt-item">{{ result.ProcessingZone }}</div>
            </v-sheet>
          </v-flex>
        </v-layout>
        ...
        <v-layout row wrap mt-3>
          <v-flex md8 pl-4>
            ...
            <div class="url font-weight-bold">Verification Code: <span class="font-weight-regular">{{ result.ReceiptNumber }}</span></div>
          </v-flex>
